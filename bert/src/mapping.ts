...
const languageMap: { [key: string]: string } = {
  ...
  'Catalan': 'ca',
  'Cebuano': 'ceb',
  'Sorani-Kurdish': 'ckb', // not same as kurdish
  'Mandarin Chinese': 'zh',
  'Czech': 'cs',
  'Welsh': 'cy',
  'Danish': 'da',
...
export { languageMap, iso639_mapping };